    ...
    if age is not None:
        ...
        if age<=18 or age>65:
            return build_validation_result(
                False,
                "age",
                "You should be between 18 and 65 years old to use this service, "
                "please provide a different age.",
            )

    # Validate that the user's investment amount is = > $500
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "The minimum investment amount should be over $5,000, "
                "Please provide an investment amount meets this requirement.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Gets invocation source for Lex dialog "DialogCodeHook" is expected
    ...
    # for the first violation detected.
        ...
        # If the data provider by user is not valid: 
        # The elicitSlot dialog is used to re-prompt for the first violation detected. 
        ...
        # Once all slots are valid, delegate a dialog is returned to Lex to choose the next course of action.
        return delegate(output_session_attributes, get_slots(intent_request))
        
    recommendation = get_recommendation(risk_level)

    # Return a message with the recommendation result
    return close(
        intent_request["sessionAttributes"],
        "Fulfilled",
        {
            ...
            Acording to the risk level you defined, it is recommended that you choose an investment portfolio with {}
            """.format(
...
def get_recommendation(risk_level):
    """
    Provides investment recommendatin based on risk tolerance selected.
    """
    recommendation = ""
    if risk_level == "None":
...
def dispatch(intent_request):
    ...
    # Dispatch to bot's intent handlers. The intent name is the intent name in Lex
